...
class MainWindow(QMainWindow, Ui_MainWindow):
    ...
    def __init__(self, parent=None):
        ...
        self.numGenLineEdit.setText("10")
        ...
        self.updateTable()
        self.updateLEDTable()
        self.setWindowTitle("Facility Calibration Unit")
        ...
        if self.led_outputs is not None:
            for i, (wavelength, max_amp, FWHM, led_locations) in enumerate(self.LED_LIST):
                ...
                for location in led_locations:
                    ...
                    # Send 8 most significant bits
                    self.ser.write(chr(PWM_value / 256))
                    # Send 8 least most significant bits
                    self.ser.write(chr(PWM_value % 256))
